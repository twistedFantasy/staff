...
.edit-user-dialog .theme--light.v-select .v-select__selections,
.theme--light.v-label {
  color: #001c29 !important;
}
.edit-user-dialog .theme--light.v-input:not(.v-input--is-disabled) input {
  color: #001c29 !important;
}
.v-chip__content,
.v-chip__close {
...
.edit-user-dialog .v-icon.material-icons.theme--light {
  color: #001c29 !important;
}
.edit-user-dialog
  .indigo.theme--dark.v-btn:not(.v-btn--icon):not(.v-btn--flat) {
  background: #001c29 !important;
}
.edit-user-dialog .blue--text.text--darken-1 {
  color: #001c29 !important;
}
</style>
